...
function createMediaDockV3Api(ipcRenderer) {
  return Object.freeze({
    ...
    checkProductUpdate: () => ipcRenderer.invoke(MEDIA_DOCK_V3_CHANNELS.checkProductUpdate),
    prepareProductUpdate: () => ipcRenderer.invoke(MEDIA_DOCK_V3_CHANNELS.prepareProductUpdate),
    installProductUpdate: () => ipcRenderer.invoke(MEDIA_DOCK_V3_CHANNELS.installProductUpdate),
